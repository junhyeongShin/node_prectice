...
interface IUser extends mongoose.Document {
    ...
    profileImg: string,
    mobile: string,
    joinTime: Date, // 회원 가입 일시
    outTime: Date, // 회원 탈퇴 일시
    restTime: Date, // 휴먼 계정 날짜
    Token: string, // 회원 토큰
    ...
    point: number, // 마일리지
    emailAgree : boolean, // 이메일 수신동의
    SMSAgree : boolean, // SMS 수신 동의
    infoOpenAgree : boolean, // 정보 공개 수신 동의
    address : {
...
export const user = mongoose.model<IUser>('user', user_schema, 'user');